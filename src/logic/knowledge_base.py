...
MAPPER = {
    ...
    'L1': 'Món nước', 'L2': 'Món khô', 'L3': 'Món tráng miệng',  'L4': 'Món gỏi', 'L5': 'Món nướng', 'L6': 'Món xào', 'L7': 'Món hấp', 'L8': 'Món lẩu', 'L9': 'Món cháo', 'L10': 'Món bánh',
    'M1': 'Mùa nước nổi', 'M2': 'Mùa mưa', 'M3': 'Mùa khô', 'M4': 'Mùa tết', 'M5': 'Mùa trái cây', 'M6':'Quanh năm',
    'N1': 'Hải sản', 'N2': 'Cá', 'N3': 'Bún', 'N4': 'Hủ tiếu',  'N5': 'Bánh tằm', 'N6': 'Bột', 'N7': 'Nếp','N8': 'Gạo','N9': 'Thịt', 'N10': 'Trứng', 'N11': 'Trái cây', 'N12': 'Côn trùng',

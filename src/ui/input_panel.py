...
class InputPanel(QWidget):
    ...
    def __init__(self):
        ...
        # Nút Tùy chọn (Style sẽ được MainWindow thiết lập chung để đồng bộ)
        ...
        self.top_bar.addStretch() # Đẩy nút Tùy chọn sang góc phải
        ...
        checkbox_style = """
            ...
            QCheckBox::indicator:unchecked {
                border: 2px solid #BDC3C7; border-radius: 4px; background-color: white; width: 20px; height: 20px;
            }
            QCheckBox::indicator:checked {
                border: none; background-color: transparent; 
                image: url(assets/icons/tick_xanh.png); width: 24px; height: 24px;
            }
